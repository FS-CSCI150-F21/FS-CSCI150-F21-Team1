-- script to create rest_info database, rest_manager user that accesses database from php backend, and appropriate menu table schemas and their records.
...
-- grant privileges to newly created user.  this statement is most likely to fail if not ran from root.
